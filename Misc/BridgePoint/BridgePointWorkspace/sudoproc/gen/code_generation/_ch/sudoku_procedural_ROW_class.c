/*----------------------------------------------------------------------------
 * File:  sudoku_procedural_ROW_class.c
 *
 * Class:       row  (ROW)
 ...
 */
static Escher_SetElement_s sudoku_procedural_ROW_container[ sudoku_procedural_ROW_MAX_EXTENT_SIZE ];
static sudoku_procedural_ROW sudoku_procedural_ROW_instances[ sudoku_procedural_ROW_MAX_EXTENT_SIZE ];
Escher_Extent_t pG_sudoku_procedural_ROW_extent = {
  {0}, {0}, &sudoku_procedural_ROW_container[ 0 ],
  (Escher_iHandle_t) &sudoku_procedural_ROW_instances,
  sizeof( sudoku_procedural_ROW ), sudoku_procedural_ROW_STATE_1, sudoku_procedural_ROW_MAX_EXTENT_SIZE
  };
 ...
 */
i_t
sudoku_procedural_ROW_op_eliminate( sudoku_procedural_ROW * self )
{
...
{if ( 0 != self ) {
sudoku_procedural_CELL * CELL_R2;
Escher_Iterator_s iCELL_R2;
Escher_IteratorReset( &iCELL_R2, &self->CELL_R2 );
while ( 0 != ( CELL_R2 = (sudoku_procedural_CELL *) Escher_IteratorNext( &iCELL_R2 ) ) ) {
...
while ( 0 != ( ELIGIBLE_R8 = (sudoku_procedural_ELIGIBLE *) Escher_IteratorNext( &iELIGIBLE_R8 ) ) ) {
  ...
  if ( ( 9 == c ) ) {
    ...
    { Escher_Iterator_s iter14;
  sudoku_procedural_ELIGIBLE * sudoku_procedural_ELIGIBLEiter14;
  Escher_IteratorReset( &iter14, eligibles );
  while ( (sudoku_procedural_ELIGIBLEiter14 = (sudoku_procedural_ELIGIBLE *)Escher_IteratorNext( &iter14 )) != 0 ) {
    eligible = sudoku_procedural_ELIGIBLEiter14; {
 ...
 */
i_t
sudoku_procedural_ROW_op_prune( sudoku_procedural_ROW * self )
{
...
Escher_IteratorReset( &iCELL_R2, &self->CELL_R2 );
while ( 0 != ( CELL_R2 = (sudoku_procedural_CELL *) Escher_IteratorNext( &iCELL_R2 ) ) ) {
sudoku_procedural_DIGIT * selected = CELL_R2->DIGIT_R9;
...
while ( 0 != ( ELIGIBLE_R8 = (sudoku_procedural_ELIGIBLE *) Escher_IteratorNext( &iELIGIBLE_R8 ) ) ) {
  ...
  /* FOR EACH eligible IN eligibles */
  { Escher_Iterator_s iter15;
  sudoku_procedural_ELIGIBLE * sudoku_procedural_ELIGIBLEiter15;
  Escher_IteratorReset( &iter15, eligibles );
  while ( (sudoku_procedural_ELIGIBLEiter15 = (sudoku_procedural_ELIGIBLE *)Escher_IteratorNext( &iter15 )) != 0 ) {
    eligible = sudoku_procedural_ELIGIBLEiter15; {
    sudoku_procedural_DIGIT * answerdigit;
    /* FOR EACH answerdigit IN answerdigits */
    { Escher_Iterator_s iter17;
  sudoku_procedural_DIGIT * sudoku_procedural_DIGITiter17;
  Escher_IteratorReset( &iter17, answerdigits );
  while ( (sudoku_procedural_DIGITiter17 = (sudoku_procedural_DIGIT *)Escher_IteratorNext( &iter17 )) != 0 ) {
    answerdigit = sudoku_procedural_DIGITiter17; {
...
Escher_Iterator_s iCELL_R2;
Escher_IteratorReset( &iCELL_R2, &self->CELL_R2 );
while ( 0 != ( selected = (sudoku_procedural_CELL *) Escher_IteratorNext( &iCELL_R2 ) ) ) {
  ...
  { Escher_Iterator_s iter16;
  sudoku_procedural_CELL * sudoku_procedural_CELLiter16;
  Escher_IteratorReset( &iter16, opencells );
  while ( (sudoku_procedural_CELLiter16 = (sudoku_procedural_CELL *)Escher_IteratorNext( &iter16 )) != 0 ) {
    opencell = sudoku_procedural_CELLiter16; {
    i_t c;
 ...
 */
void
sudoku_procedural_ROW_R1_Link( sudoku_procedural_SEQUENCE * supertype, sudoku_procedural_ROW * subtype )
{
  if ( (supertype == 0) || (subtype == 0) )
  {
    ROX_EMPTY_HANDLE_TRACE( "ROW", "sudoku_procedural_ROW_R1_Link" )
    return;
  }
  ...
  supertype->R1_object_id = sudoku_procedural_ROW_CLASS_NUMBER;
}
 ...
 * State 1:  [solving]
 */
static void sudoku_procedural_ROW_act1( sudoku_procedural_ROW *, const Escher_xtUMLEvent_t * const );
static void
sudoku_procedural_ROW_act1( sudoku_procedural_ROW * self, const Escher_xtUMLEvent_t * const event )
{
  /* IF ( ( 100 == self.prune() ) ) */
  if ( ( 100 == sudoku_procedural_ROW_op_prune(self) ) ) {
    /* GENERATE ROW2:solved() TO self */
    {
  Escher_xtUMLEvent_t * e = Escher_NewxtUMLEvent( self, &sudoku_procedural_ROWevent2c );
  Escher_SendSelfEvent( e );
  }
  }
  else if ( ( 100 == sudoku_procedural_ROW_op_eliminate(self) ) ) {
    /* GENERATE ROW2:solved() TO self */
    {
  Escher_xtUMLEvent_t * e = Escher_NewxtUMLEvent( self, &sudoku_procedural_ROWevent2c );
  Escher_SendSelfEvent( e );
    ...
    if ( ( sequence->requests >= 1 ) ) {
      ...
      {
  Escher_xtUMLEvent_t * e = Escher_NewxtUMLEvent( r, &sudoku_procedural_ROWevent1c );
  Escher_SendEvent( e );
  }
    }
    else {
 ...
 * State 3:  [solved]
 */
static void sudoku_procedural_ROW_act3( sudoku_procedural_ROW *, const Escher_xtUMLEvent_t * const );
static void
sudoku_procedural_ROW_act3( sudoku_procedural_ROW * self, const Escher_xtUMLEvent_t * const event )
{
  sudoku_procedural_SEQUENCE * sequence; /* sequence (SEQUENCE) */
...
const Escher_xtUMLEventConstant_t sudoku_procedural_ROWevent1c = {
  sudoku_procedural_DOMAIN_ID, sudoku_procedural_ROW_CLASS_NUMBER, SUDOKU_PROCEDURAL_ROWEVENT1NUM,
  ESCHER_IS_INSTANCE_EVENT };

const Escher_xtUMLEventConstant_t sudoku_procedural_ROWevent2c = {
  sudoku_procedural_DOMAIN_ID, sudoku_procedural_ROW_CLASS_NUMBER, SUDOKU_PROCEDURAL_ROWEVENT2NUM,
  ESCHER_IS_INSTANCE_EVENT };
 ...
 */
static const Escher_SEMcell_t sudoku_procedural_ROW_StateEventMatrix[ 2 + 1 ][ 2 ] = {
  /* row 0:  uninitialized state (for creation events) */
  { EVENT_CANT_HAPPEN, EVENT_CANT_HAPPEN },
  /* row 1:  sudoku_procedural_ROW_STATE_1 (solving) */
  { sudoku_procedural_ROW_STATE_1, sudoku_procedural_ROW_STATE_3 },
  /* row 2:  sudoku_procedural_ROW_STATE_3 (solved) */
   ...
   */
  static const StateAction_t sudoku_procedural_ROW_acts[ 3 ] = {
    (StateAction_t) 0,
    (StateAction_t) sudoku_procedural_ROW_act1,  /* solving */
    (StateAction_t) sudoku_procedural_ROW_act3  /* solved */
  };
 ...
 */
void
sudoku_procedural_ROW_Dispatch( Escher_xtUMLEvent_t * event )
{
  ...
  if ( 0 != instance ) {
    ...
    if ( current_state > 2 ) {
      ...
      next_state = sudoku_procedural_ROW_StateEventMatrix[ current_state ][ event_number ];
      if ( next_state <= 2 ) {
        STATE_TXN_START_TRACE( "ROW", current_state, state_name_strings[ current_state ] )
        /* Execute the state action and update the current state.  */
        ( *sudoku_procedural_ROW_acts[ next_state ] )( instance, event );
