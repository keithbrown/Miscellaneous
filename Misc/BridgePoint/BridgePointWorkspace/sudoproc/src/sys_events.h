...
#define GetIsPolyEventInFlight(X) (GetOoaEventFlags(X) & ESCHER_IS_POLY_IN_FLIGHT)
#define SetIsPolyEventInFlight(X) (GetOoaEventFlags(X) |= ESCHER_IS_POLY_IN_FLIGHT)
#define ClearIsPolyEventInFlight(X) (GetOoaEventFlags(X) &= ~(Escher_EventFlags_t)ESCHER_IS_POLY_IN_FLIGHT)
