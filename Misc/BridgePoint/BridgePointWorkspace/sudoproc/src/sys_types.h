...
#define ESCHER_SYS_MAX_OBJECT_EXTENT 1594
#define ESCHER_SYS_MAX_ASSOCIATION_EXTENT 594
#define ESCHER_SYS_MAX_TRANSIENT_EXTENT 6000
...
#define sudoku_procedural_DOMAIN_ID 0
