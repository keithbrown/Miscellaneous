...
var JiraApi = exports.JiraApi = function(protocol, host, username, password, apiVersion, verbose, strictSSL) {
    ...
    this.searchJira = function(searchString, optional, callback) {
        ...
        var options = {
            ...
            body: {
                ...
                maxResults: optional.maxResults || 100000,
                fields: optional.fields || ["summary", "status", "assignee", "description", "reporter","created"]
            }
        };
...
// [Jira Doc](http://docs.atlassian.com/jira/REST/latest/#id290791)
	...
	this.makeTransition = function(issueId, options, callback) {
        var options = {
            rejectUnauthorized: this.strictSSL,
			body: options,
            uri: this.makeUri('/issue/' + issueId + '/transitions?expand=transitions.fields'),
